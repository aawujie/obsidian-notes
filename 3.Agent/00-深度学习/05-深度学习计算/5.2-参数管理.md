...
# 5.2\. 参数管理[¶](#id1 "Permalink to this heading")

[  Colab \[mxnet\] ](https://colab.research.google.com/github/d2l-ai/d2l-zh-colab/blob/master/chapter%5Fdeep-learning-computation/parameters.ipynb)

 Open the notebook in Colab

[  Colab \[pytorch\] ](https://colab.research.google.com/github/d2l-ai/d2l-zh-pytorch-colab/blob/master/chapter%5Fdeep-learning-computation/parameters.ipynb)

 Open the notebook in Colab

[  Colab \[tensorflow\] ](https://colab.research.google.com/github/d2l-ai/d2l-zh-tensorflow-colab/blob/master/chapter%5Fdeep-learning-computation/parameters.ipynb)

 Open the notebook in Colab

[  Colab \[paddle\] ](https://colab.research.google.com/github/d2l-ai/d2l-zh-paddle-colab/blob/master/chapter%5Fdeep-learning-computation/parameters.ipynb)
...
## 5.2.1\. 参数访问[¶](#id2 "Permalink to this heading")
...
### 5.2.1.1\. 目标参数[¶](#id3 "Permalink to this heading")
...
### 5.2.1.2\. 一次性访问所有参数[¶](#id4 "Permalink to this heading")
...
### 5.2.1.3\. 从嵌套块收集参数[¶](#id5 "Permalink to this heading")
...
## 5.2.2\. 参数初始化[¶](#id6 "Permalink to this heading")

知道了如何访问参数后，现在我们看看如何正确地初始化参数。 我们在[4.8节](../chapter%5Fmultilayer-perceptrons/numerical-stability-and-init.html#sec-numerical-stability)中讨论了良好初始化的必要性。 深度学习框架提供默认随机初始化， 也允许我们创建自定义初始化方法， 满足我们通过其他规则实现初始化权重。
...
### 5.2.2.1\. 内置初始化[¶](#id7 "Permalink to this heading")
...
### 5.2.2.2\. 自定义初始化[¶](#id8 "Permalink to this heading")

有时，深度学习框架没有提供我们需要的初始化方法。 在下面的例子中，我们使用以下的分布为任意权重参数\\(w\\)定义初始化方法：

(5.2.1)[¶](#equation-chapter-deep-learning-computation-parameters-0 "Permalink to this equation")\\\[\\begin{split}\\begin{aligned} w \\sim \\begin{cases} U(5, 10) & \\text{ 可能性 } \\frac{1}{4} \\\\ 0 & \\text{ 可能性 } \\frac{1}{2} \\\\ U(-10, -5) & \\text{ 可能性 } \\frac{1}{4} \\end{cases} \\end{aligned}\\end{split}\\\]
...
## 5.2.3\. 参数绑定[¶](#id9 "Permalink to this heading")
...
## 5.2.4\. 小结[¶](#id10 "Permalink to this heading")

* 我们有几种方法可以访问、初始化和绑定模型参数。
* 我们可以使用自定义初始化方法。

## 5.2.5\. 练习[¶](#id11 "Permalink to this heading")

1. 使用 [5.1节](model-construction.html#sec-model-construction)中定义的`FancyMLP`模型，访问各个层的参数。
...
[](https://discuss.d2l.ai/t/1830)

[](https://discuss.d2l.ai/t/11778)
...
* [5.2\. 参数管理](#)  
   * [5.2.1\. 参数访问](#id2)  
         * [5.2.1.1\. 目标参数](#id3)  
         * [5.2.1.2\. 一次性访问所有参数](#id4)  
         * [5.2.1.3\. 从嵌套块收集参数](#id5)  
   * [5.2.2\. 参数初始化](#id6)  
         * [5.2.2.1\. 内置初始化](#id7)  
         * [5.2.2.2\. 自定义初始化](#id8)  
   * [5.2.3\. 参数绑定](#id9)  
...
[ Previous 5.1\. 层和块 ](model-construction.html) [ Next 5.3\. 延后初始化 ](deferred-init.html)