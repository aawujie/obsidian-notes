---
title: 2.7-查阅文档
source: https://zh.d2l.ai/chapter_preliminaries/lookup-api.html
converted_at: 2026-02-28
---

# 2.7\. 查阅文档[¶](#id1 "Permalink to this heading")

[  Colab \[mxnet\] ](https://colab.research.google.com/github/d2l-ai/d2l-zh-colab/blob/master/chapter%5Fpreliminaries/lookup-api.ipynb)

 Open the notebook in Colab

[  Colab \[pytorch\] ](https://colab.research.google.com/github/d2l-ai/d2l-zh-pytorch-colab/blob/master/chapter%5Fpreliminaries/lookup-api.ipynb)

 Open the notebook in Colab

[  Colab \[tensorflow\] ](https://colab.research.google.com/github/d2l-ai/d2l-zh-tensorflow-colab/blob/master/chapter%5Fpreliminaries/lookup-api.ipynb)

 Open the notebook in Colab

[  Colab \[paddle\] ](https://colab.research.google.com/github/d2l-ai/d2l-zh-paddle-colab/blob/master/chapter%5Fpreliminaries/lookup-api.ipynb)
...
## 2.7.1\. 查找模块中的所有函数和类[¶](#id2 "Permalink to this heading")
...
## 2.7.2\. 查找特定函数和类的用法[¶](#id3 "Permalink to this heading")
...
ones(...)
    ones([*](#id4)size, [*](#id6), out=None, dtype=None, layout=torch.strided, device=None, requires_grad=False) -> Tensor
...
## 2.7.3\. 小结[¶](#id8 "Permalink to this heading")

* 官方文档提供了本书之外的大量描述和示例。
* 可以通过调用`dir`和`help`函数或在Jupyter记事本中使用`?`和`??`查看API的用法文档。

## 2.7.4\. 练习[¶](#id9 "Permalink to this heading")
...
[](https://discuss.d2l.ai/t/1763)

[](https://discuss.d2l.ai/t/11686)

 

* [2.7\. 查阅文档](#)  
   * [2.7.1\. 查找模块中的所有函数和类](#id2)  
   * [2.7.2\. 查找特定函数和类的用法](#id3)  
   * [2.7.3\. 小结](#id8)  
   * [2.7.4\. 练习](#id9)

[ Previous 2.6\. 概率 ](probability.html) [ Next 3\. 线性神经网络 ](../chapter%5Flinear-networks/index.html)