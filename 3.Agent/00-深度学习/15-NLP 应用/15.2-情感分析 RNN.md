---
title: 15.2-情感分析 RNN
source: https://zh.d2l.ai/chapter_natural-language-processing-applications/sentiment-analysis-rnn.html
converted_at: 2026-02-28
---

# 15.2\. 情感分析：使用循环神经网络[¶](#sec-sentiment-rnn "Permalink to this heading")

[  Colab \[mxnet\] ](https://colab.research.google.com/github/d2l-ai/d2l-zh-colab/blob/master/chapter%5Fnatural-language-processing-applications/sentiment-analysis-rnn.ipynb)

 Open the notebook in Colab

[  Colab \[pytorch\] ](https://colab.research.google.com/github/d2l-ai/d2l-zh-pytorch-colab/blob/master/chapter%5Fnatural-language-processing-applications/sentiment-analysis-rnn.ipynb)

 Open the notebook in Colab

[  Colab \[tensorflow\] ](https://colab.research.google.com/github/d2l-ai/d2l-zh-tensorflow-colab/blob/master/chapter%5Fnatural-language-processing-applications/sentiment-analysis-rnn.ipynb)

 Open the notebook in Colab

[  Colab \[paddle\] ](https://colab.research.google.com/github/d2l-ai/d2l-zh-paddle-colab/blob/master/chapter%5Fnatural-language-processing-applications/sentiment-analysis-rnn.ipynb)
...
与词相似度和类比任务一样，我们也可以将预先训练的词向量应用于情感分析。由于[15.1节](sentiment-analysis-and-dataset.html#sec-sentiment)中的IMDb评论数据集不是很大，使用在大规模语料库上预训练的文本表示可以减少模型的过拟合。作为[图15.2.1](#fig-nlp-map-sa-rnn)中所示的具体示例，我们将使用预训练的GloVe模型来表示每个词元，并将这些词元表示送入多层双向循环神经网络以获得文本序列表示，该文本序列表示将被转换为情感分析输出([Maas _et al._, 2011](../chapter%5Freferences/zreferences.html#id104 "Maas, A. L., Daly, R. E., Pham, P. T., Huang, D., Ng, A. Y., & Potts, C. (2011). Learning word vectors for sentiment analysis. Proceedings of the 49th annual meeting of the association for computational linguistics: Human language technologies-volume 1 (pp. 142–150)."))。对于相同的下游应用，我们稍后将考虑不同的架构选择。

图15.2.1 将GloVe送入基于循环神经网络的架构，用于情感分析[¶](#id8 "Permalink to this image")
...
## 15.2.1\. 使用循环神经网络表示单个文本[¶](#id3 "Permalink to this heading")
...
## 15.2.2\. 加载预训练的词向量[¶](#id4 "Permalink to this heading")
...
## 15.2.3\. 训练和评估模型[¶](#id5 "Permalink to this heading")
...
[](https://discuss.d2l.ai/t/5723)

[](https://discuss.d2l.ai/t/5724)

[](https://discuss.d2l.ai/t/11826)

 

* [15.2\. 情感分析：使用循环神经网络](#)  
   * [15.2.1\. 使用循环神经网络表示单个文本](#id3)  
   * [15.2.2\. 加载预训练的词向量](#id4)  
   * [15.2.3\. 训练和评估模型](#id5)  
   * [15.2.4\. 小结](#id6)  
   * [15.2.5\. 练习](#id7)

[ Previous 15.1\. 情感分析及数据集 ](sentiment-analysis-and-dataset.html) [ Next 15.3\. 情感分析：使用卷积神经网络 ](sentiment-analysis-cnn.html)