...
| **分词方法**        | <span style="color:rgb(255, 77, 77)"><b>Byte Pair Encoding (BPE)</b></span> | 子词级分词         |
...
BPE 字节对编码是大模型主流分词算法，<span style="color:rgb(255, 77, 77)">先把文本拆成基础字节单元</span>，<span style="color:rgb(255, 77, 77)">反复合并出现频率最高的相邻字节对生成子词词表</span>，推理时按最长匹配拆分文本，<span style="color:rgb(195, 117, 255)">靠子词兼顾词表大小与生僻词、复合词识别</span>，<span style="color:rgb(255, 77, 77)">解决纯单词词表过大、纯字符编码效率低的问题</span>。
