...
**一句话：** 复数是多了乘法结构的二维向量——这个乘法不是打补丁加上的，而是**核心结构**。有了它，<span style="color:rgb(255, 77, 77)">复数从一个"平面上的点"升级成了一个完整的数系</span>，能做加减乘除、能分析、<span style="color:rgb(255, 77, 77)">能微积分</span>。二维向量始终只能加法和数乘，缺少了这个内部乘法，<span style="color:rgb(255, 77, 77)">所以它只是一个空间，不是代数。</span>
