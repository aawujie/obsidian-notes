...
3.  **模型对比**：<span style="color:rgb(195, 121, 251)">如果两个模型都被拒绝了，通常看哪个模型的 GRS 统计量更小</span>，或者哪个模型解释的“异象数量”更多（见第四章内容）。
...
1.  **残差的正态性**：它假设<span style="color:rgb(195, 121, 251)">回归残差服从独立同分布（IID）的正态分布</span>。但在<span style="color:rgb(255, 77, 77)">实际股市中，收益率往往有“肥尾”效应</span>。
