...
<span style="color:rgb(255, 77, 77)">$\beta$ 就是我们最关心的"斜率"（市值每变 1，收益变多少）</span>。

### <span style="color:rgb(255, 77, 77)">股票数据的两大毒瘤</span>

- **<span style="color:rgb(195, 117, 255)">截面相关</span>**：同一个月，所有股票的残差几乎同方向（市场因子、行业因子等）
- **<span style="color:rgb(195, 117, 255)">时间序列相关</span>**：同一只股票不同月份残差也相关

普通 pooled OLS、固定效应、甚至单向聚类都会<span style="color:rgb(255, 77, 77)">**严重低估标准误</span>** → t 值爆炸 → 假显著。
...
| 写法          | 例子                 | 常见场景                                                      |
| ----------- | ------------------ | --------------------------------------------------------- |
| t-stat      | t-stat = 3.28      | <span style="color:rgb(255, 77, 77)">顶刊最常见</span>（JF、JFE） |
...
- <span style="color:rgb(255, 77, 77)">|t| > 3.00 → 顶刊真正开始心动</span>
- |t| > 5.00 → 直接 JF/RFS 一作

一句话：<span style="color:rgb(255, 77, 77)">**t-stat = 平均收益 ÷ 最诚实的标准误</span>（$SE_{FM}$）**
