...
# 5.4\. 自定义层[¶](#id1 "Permalink to this heading")

[  Colab \[mxnet\] ](https://colab.research.google.com/github/d2l-ai/d2l-zh-colab/blob/master/chapter%5Fdeep-learning-computation/custom-layer.ipynb)

 Open the notebook in Colab

[  Colab \[pytorch\] ](https://colab.research.google.com/github/d2l-ai/d2l-zh-pytorch-colab/blob/master/chapter%5Fdeep-learning-computation/custom-layer.ipynb)

 Open the notebook in Colab

[  Colab \[tensorflow\] ](https://colab.research.google.com/github/d2l-ai/d2l-zh-tensorflow-colab/blob/master/chapter%5Fdeep-learning-computation/custom-layer.ipynb)

 Open the notebook in Colab

[  Colab \[paddle\] ](https://colab.research.google.com/github/d2l-ai/d2l-zh-paddle-colab/blob/master/chapter%5Fdeep-learning-computation/custom-layer.ipynb)
...
## 5.4.1\. 不带参数的层[¶](#id2 "Permalink to this heading")

首先，我们构造一个没有任何参数的自定义层。 回忆一下在[5.1节](model-construction.html#sec-model-construction)对块的介绍， 这应该看起来很眼熟。 下面的`CenteredLayer`类要从其输入中减去均值。 要构建它，我们只需继承基础层类并实现前向传播功能。
...
## 5.4.2\. 带参数的层[¶](#id3 "Permalink to this heading")
...
## 5.4.3\. 小结[¶](#id4 "Permalink to this heading")

* 我们可以通过基本层类设计自定义层。这允许我们定义灵活的新层，其行为与深度学习框架中的任何现有层不同。
* 在自定义层定义完成后，我们就可以在任意环境和网络架构中调用该自定义层。
* 层可以有局部参数，这些参数可以通过内置函数创建。

## 5.4.4\. 练习[¶](#id5 "Permalink to this heading")

1. 设计一个接受输入并计算张量降维的层，它返回\\(y\_k = \\sum\_{i, j} W\_{ijk} x\_i x\_j\\)。
...
[](https://discuss.d2l.ai/t/1836)

[](https://discuss.d2l.ai/t/11780)
...
[ Previous 5.3\. 延后初始化 ](deferred-init.html) [ Next 5.5\. 读写文件 ](read-write.html)