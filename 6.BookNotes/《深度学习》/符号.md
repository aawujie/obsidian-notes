---
title: 符号
source: https://zh.d2l.ai/chapter_notation/index.html
converted_at: 2026-02-28
---

# 符号[¶](#chap-notation "Permalink to this heading")

本书中使用的符号概述如下。

## 数字[¶](#id2 "Permalink to this heading")
...
* \\(\\mathsf{X}\\)：张量
* \\(\\mathbf{I}\\)：单位矩阵
* \\(x\_i\\),\\(\[\\mathbf{x}\]\_i\\)：向量\\(\\mathbf{x}\\)第\\(i\\)个元素
* \\(x\_{ij}\\),\\(\[\\mathbf{X}\]\_{ij}\\)：矩阵\\(\\mathbf{X}\\)第\\(i\\)行第\\(j\\)列的元素

## 集合论[¶](#id3 "Permalink to this heading")
...
## 函数和运算符[¶](#id4 "Permalink to this heading")
...
## 微积分[¶](#id5 "Permalink to this heading")
...
## 概率与信息论[¶](#id6 "Permalink to this heading")
...
* \\(H(X)\\): 随机变量\\(X\\)的熵
* \\(D\_{\\mathrm{KL}}(P\\|Q)\\): \\(P\\)和\\(Q\\)的KL-散度

## 复杂度[¶](#id7 "Permalink to this heading")
...
[ Previous 安装 ](../chapter%5Finstallation/index.html) [ Next 1\. 引言 ](../chapter%5Fintroduction/index.html)