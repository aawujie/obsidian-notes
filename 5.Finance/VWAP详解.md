...
| Band | 用途                                                                 |
| :--- | :----------------------------------------------------------------- |
| ±1σ  | <span style="color:rgb(195, 117, 255)">正常波动范围</span>，触及后大概率回弹      |
| ±2σ  | <span style="color:rgb(195, 117, 255)">异常波动</span>，触及后可能趋势延续也可能反转  |
| ±3σ  | <span style="color:rgb(195, 117, 255)">极端波动</span>，统计上仅 ~0.3% 概率触及 |
