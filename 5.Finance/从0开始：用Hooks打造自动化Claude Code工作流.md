...
fetched: 2026-05-23
type: article
tags: [Claude Code, Hooks, 自动化, 工作流]
---

## 推文信息

- **作者**: Vince 聊开发 (@vincemask)
- **发布时间**: 2026-05-13 07:04:45 UTC
- **互动数据**: 18 回复 · 66 转发 · 320 喜欢 · 663 书签 · 70,496 查看
- **原文链接**: https://x.com/vincemask/status/2054457804057100405
- **作者简介**: AI 开发者 / 架构师 · Building in Public，专注 Claude Code 工作流与 AI Agent 实战
- **GitHub**: https://github.com/vincemask
...
[Claude Code hooks](https://code.claude.com/docs/en/hooks-guide) 是在 Claude 生命周期的固定节点自动执行的 shell 命令。不需要你给 Claude 下任何指令，Hook 就已经跑完了。
...
[GitButler 的指南](https://blog.gitbutler.com/automate-your-ai-workflows-with-claude-code-hooks)：从三个开始：PostToolUse 自动格式化、PreToolUse 拦截危险命令、Stop 桌面通知，覆盖最广，上手最容易。
...
![生命周期事件](https://pbs.twimg.com/media/HIH7U5hbUAAFQmp.jpg)
...
每次 Edit 或 Write 之后跑 [Prettier](https://prettier.io/)。Claude 逐文件改代码导致的格式不一致，一劳永逸：
...
需要 [jq](https://jqlang.github.io/jq/) 做 JSON 解析，macOS 上安装：
...
![Hook 配置示例](https://pbs.twimg.com/media/HIH7lpsacAAPjb4.jpg)
...
![退出码体系](https://pbs.twimg.com/media/HIaVLEUa4AAPoBM.jpg)
...
![总结](https://pbs.twimg.com/media/HIIOw7LbkAAkJpP.jpg)
...
| 序号 | 描述 | URL |
|------|------|-----|
| 封面图 | 文章封面 | https://pbs.twimg.com/media/HIIOw7LbkAAkJpP.jpg |
| 图片1 | 生命周期事件图 | https://pbs.twimg.com/media/HIH7U5hbUAAFQmp.jpg |
| 图片2 | Hook 配置示例 | https://pbs.twimg.com/media/HIH7lpsacAAPjb4.jpg |
| 图片3 | 退出码体系 | https://pbs.twimg.com/media/HIaVLEUa4AAPoBM.jpg |